...
/**
 * Record para requisição de atualização de configuração de metas e comissões.
 ...
 * @version 1.0
 */
public record UpdateSalesTargetConfigRequest(
     ...
     */
    public UpdateSalesTargetConfigRequest {
        if (storeCode != null) {
