package com.sysconard.business.exception.config;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handler para exceções de relatório de vendas
     */
    @ExceptionHandler(StoreReportException.class)
    public ResponseEntity<ApiErrorResponse> handleStoreReportException(
            StoreReportException ex, WebRequest request) {
        
        logger.error("Erro no relatório de vendas: {}", ex.getMessage());
