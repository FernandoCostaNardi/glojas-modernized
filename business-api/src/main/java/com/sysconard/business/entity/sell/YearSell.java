...
/**
 * Entidade YearSell que representa as vendas anuais de uma loja.
 ...
 */
@Entity
@Table(name = "year_sells")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class YearSell {
    
    /**
     * Identificador único da venda anual.
    ...
    /**
     * Valor total das vendas anuais.
     * Representa o valor total consolidado de todas as vendas do ano.
     */
