            ...
            <div className="p-3 md:p-6 w-full max-w-full box-border">
              ...
              <div className="mb-4 md:mb-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
                  <div>
                    <h1 className="text-xl md:text-2xl font-bold text-smart-gray-900">
                      Códigos de Origem
                    </h1>
                  ...
                  <button
                    ...
                    className="w-full md:w-auto inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-smart-blue-600 hover:bg-smart-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-smart-blue-500 transition-colors duration-200"
                  >
              ...
              {/* Error Display */}
              {error && (
                <div className="mb-4 md:mb-6 p-4 bg-red-50 border border-red-200 rounded-md">
                  <div className="flex">
              ...
              {/* Table */}
              <div className="bg-white shadow rounded-lg w-full max-w-full box-border">
                <div className="px-3 md:px-6 py-3 md:py-4 border-b border-smart-gray-200">
                  <h3 className="text-base md:text-lg font-medium text-smart-gray-900">
                    Códigos de Origem
                  </h3>
                </div>
                <div className="p-3 md:p-6 w-full max-w-full overflow-x-auto">
                  <EventOriginTable
