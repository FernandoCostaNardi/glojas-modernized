...
/**
 * Interface para as propriedades do PurchaseAnalysisCardList
 */
interface PurchaseAnalysisCardListProps {
...
/**
 * Componente para exibição da lista de cards de análise de compras mobile
 ...
 */
const PurchaseAnalysisCardList: React.FC<PurchaseAnalysisCardListProps> = ({
  data,
  loading,
  error,
  onPageChange,
  ...
  const renderLoading = (): React.ReactNode => (
    <div className="flex justify-center items-center py-12">
      <div className="flex flex-col items-center">
        ...
        <p className="text-smart-gray-600 font-medium">Carregando análise de compras...</p>
      </div>
    </div>
  );
  ...
  const renderError = (): React.ReactNode => (
    <div className="flex justify-center items-center py-12">
      <div className="text-center">
        ...
        <h3 className="text-lg font-medium text-smart-gray-900 mb-2">Erro ao carregar análise de compras</h3>
  ...
  const renderPagination = (): React.ReactNode => {
    ...
    const { totalPages, currentPage: paginationCurrentPage, first, last, totalElements } = data.pagination;
    const hasNext = !last;
...
export default PurchaseAnalysisCardList;
